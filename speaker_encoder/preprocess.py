...
class DatasetLog:
    ...
    def __init__(self, root, name):
        self.text_file = open(
            Path(root, "Log_%s.txt" % name.replace("/", "_")), "w")
...
def _preprocess_speaker_dirs_vox2(speaker_dirs, dataset_name, datasets_root,
    ...
    for i, wav_lens in enumerate(
            pool.map(__preprocess_speaker, speaker_dirs), 1):
...
def preprocess_voxceleb2(datasets_root: Path,
    ...
    _preprocess_speaker_dirs_vox2(speaker_dirs, dataset_name, datasets_root,
